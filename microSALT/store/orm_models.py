...
class Projects(Base):
    ...
    CG_ID_project = Column(String(15), primary_key=True, nullable=False)
    Customer_ID_project = Column(String(15))
    date_ordered = Column(DateTime)
    Customer_ID = Column(String(15))
...
class Reports(Base):
    ...
    CG_ID_project = Column(String(15), ForeignKey("projects.CG_ID_project"), primary_key=True)
