...
def test_add_rec(caplog, dbm):
    ...
    dbm.add_rec(
        {"CG_ID_sample": "ADD1234A1", "loci": "mdh", "contig_name": "NODE_1"},
        "Seq_types",
    )
    assert (
        len(
    ...
    assert (
        len(
            dbm.query_rec(
                "Seq_types",
                {"CG_ID_sample": "XXX1234A10", "loci": "mdh", "contig_name": "NODE_1"},
            )
        )
        == 0
    )
    ...
    assert (
        len(dbm.query_rec("Reports", {"CG_ID_project": "ADD1234", "version": "1"})) > 0
    )
    assert (
        len(dbm.query_rec("Reports", {"CG_ID_project": "XXX1234", "version": "1"})) == 0
    )

    dbm.add_rec(
        {"CG_ID_sample": "ADD1234", "ID_collection": "MyCollectionFolder"},
        "Collections",
    )
    assert (
        len(
    ...
    assert (
        len(
            dbm.query_rec(
                "Collections",
                {"CG_ID_sample": "XXX1234", "ID_collection": "MyCollectionFolder"},
            )
        )
        == 0
    )
...
def test_upd_rec(sysexit, caplog, dbm):
    ...
    caplog.clear()
    dbm.add_rec(
        {"CG_ID_sample": "UPD1234A1_uniq", "Customer_ID_sample": "cust000"}, "Samples"
    )
    dbm.add_rec(
        {"CG_ID_sample": "UPD1234A2_uniq", "Customer_ID_sample": "cust000"}, "Samples"
    )
    dbm.upd_rec(
        {"Customer_ID_sample": "cust000"}, "Samples", {"Customer_ID_sample": "cust030"}
    )
    dbm.upd_rec(
        {"Customer_ID_sample": "cust000"}, "Samples", {"Customer_ID_sample": "cust030"}
    )
